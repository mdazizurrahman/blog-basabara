                                                    ...
                                                    <form method="POST" action="{{route('author.profile.update')}}" class="form-horizontal" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-line">
                                                                         <img class="img-responsive img-thumbnail" src="{{ asset('storage/uploads/author/profile/'.Auth::user()->image) }}" width="60" height="40">
                                                        ...
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <textarea rows="5" name="about" class="form-control">{{Auth::user()->about}} {{ old('about')}}</textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
